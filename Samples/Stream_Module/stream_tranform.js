...
tc.on("object", function(object) {
    ...
    console.log("Colour: %s", object.colour);
});
...
tc.write('{"name": "Carolinus", "colour": "Green"}');
tc.write('{"name": "Solarius", "colour": "Blue"}');
tc.write('{"name": "Lo Tae Zhao", "colour": "Gold"}');
tc.write('{"name": "Ommadon", "colour": "Red"}');
